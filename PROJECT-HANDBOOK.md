...
- `project-cognition lexicon` plus `project-cognition query --query-plan` bundle — graph-backed project concept candidates, `concept_decisions`, `lexicon_generation_id`, `candidate_universe_version`, `active_generation_id`, task-local cognition bundles, readiness, and `minimal_live_reads`
...
- `project-cognition lexicon` plus `project-cognition query --query-plan` bundle - default generated-project route to graph-backed project concept candidates, `concept_decisions`, `lexicon_generation_id`, `candidate_universe_version`, `active_generation_id`, task-local bundles, readiness, and `minimal_live_reads`
