...
param(
    [string]$ProjectRoot = ".",
    [ValidateSet("init", "list", "status", "resume-context", "checkpoint", "write-handoff", "validate-handoff", "confirm-handoff", "mark-ready", "mark-consumed", "close", "archive", "rebuild-index")]
    [string]$Mode = "list",
    [string]$Slug = "",
    [string]$Value = "",
