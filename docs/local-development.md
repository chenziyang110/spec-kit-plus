...
uvx --refresh --from git+https://github.com/chenziyang110/spec-kit-plus.git@your-feature-branch specify init demo-branch-test --script ps
```
...
```bash
uvx --from /mnt/c/GitHub/spec-kit-plus specify --help
uvx --from /mnt/c/GitHub/spec-kit-plus specify init demo-anywhere --ai copilot --ignore-agent-tools --script sh
```

Set an environment variable for convenience:

```bash
export SPEC_KIT_SRC=/mnt/c/GitHub/spec-kit-plus
...
```bash
specify-dev() { uvx --from /mnt/c/GitHub/spec-kit-plus specify "$@"; }
# Then
specify-dev --help
```
