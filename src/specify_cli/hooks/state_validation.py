    ...
    defaults: dict[str, dict[str, object]] = {
        ...
        "tasks": {
            "allowed": [
                ...
                "task-index.json",
                "task-generation/lane-manifest.json",
        ...
        "review": {
            "allowed": [
                ...
                "workflow-state.md",
                "approved-scope production source and tests",
            ],
            "forbidden": [
                "change approved product scope",
                "edit spec, plan, or task truth without reopening its owner",
                "waive a mandatory user journey",
                "reuse stale review evidence",
                "claim whole-product approval from a worker result",
                "push, deploy, or perform external writes without authority",
            ],
            "authoritative": [
