    ...
    def _augment_implement_skill(
        ...
        if marker not in content:
            addendum = (
                ...
                "- `spawn_agent` lanes must receive the compiled packet summary, required references, forbidden drift, validation gates, and done criteria for the task they own.\n"
                "- single-agent still means one delegated worker lane, not leader self-execution.\n"
                ...
                "- If packet compilation fails, stop and repair the planning artifacts instead of improvising delegated work from raw task text.\n"
