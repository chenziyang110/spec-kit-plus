    ...
    def augment_generated_skills(
        ...
        self._augment_shared_skill(
            ...
            (
                "\n"
                f"## {agent_name} Subagents-First Dispatch\n\n"
                f"When running `sp-specify` in {agent_name}, use Codex native subagents only for bounded evidence, challenge, and artifact-review lanes that support the current collaborative specification pass.\n"
