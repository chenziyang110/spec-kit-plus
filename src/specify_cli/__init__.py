    ...
    *,
    ...
    if freshness in block_levels:
        ...
        if freshness == "missing":
            ...
            console.print(
                "Run [cyan]/sp-map-update[/cyan] to refresh the stale graph-native project cognition baseline for the touched area, then retry. If no usable baseline remains, rebuild it with [cyan]/sp-map-scan[/cyan], then [cyan]/sp-map-build[/cyan]."
            )
        raise typer.Exit(1)
