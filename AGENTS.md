...
- Treat `templates/commands/**`, `templates/command-partials/**`, `templates/passive-skills/**`, `templates/worker-prompts/**`, `templates/project-map/**`, and generated `.specify/**` conventions as **product surfaces under development**.
