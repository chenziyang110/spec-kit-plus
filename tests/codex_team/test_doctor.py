...
def test_codex_team_doctor_surfaces_latest_runtime_transcript_and_failed_dispatches(
    ...
    packet_path = codex_team_project_root / ".specify" / "teams" / "state" / "packets" / "req-doctor.json"
    ...
    executors_dir = codex_team_project_root / ".specify" / "teams" / "state" / "executors"
    executors_dir.mkdir(parents=True, exist_ok=True)
    state_root = codex_team_project_root / ".specify" / "teams" / "state" / "agent-teams" / "doctor-batch"
    ...
    dispatch_path = codex_team_project_root / ".specify" / "teams" / "state" / "dispatch" / "req-doctor.json"
...
def test_codex_team_doctor_reports_lane_and_repo_verification_status(
    ...
    baseline_path = codex_team_project_root / ".specify" / "teams" / "state" / "baseline-build.json"
