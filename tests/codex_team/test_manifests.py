...
def test_runtime_state_payload_serializes_session_and_dispatches():
    ...
    dispatch = DispatchRecord(
        ...
        retry_count=0,
        retry_budget=0,
        delegation_metadata={"native_subagent_surface": "spawn_agent"},
    )
    ...
    assert payload["dispatches"][0]["delegation_metadata"]["native_subagent_surface"] == "spawn_agent"
...
def test_dispatch_record_round_trips_from_json():
    ...
    assert record.delegation_metadata["native_subagent_surface"] == "spawn_agent"
