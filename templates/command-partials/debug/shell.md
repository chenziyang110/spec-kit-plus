...
- Primary inputs: the user's report, the active debug-session state, the failing runtime or verification evidence, and the `specify project-cognition query` task-local bundle with readiness and returned `minimal_live_reads`.
