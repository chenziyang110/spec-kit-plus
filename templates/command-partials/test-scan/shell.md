...
- Primary inputs are live source/test files, manifest/config files, the task-local project cognition query bundle with readiness and returned `minimal_live_reads`, existing `.specify/testing/` artifacts, and project memory.
