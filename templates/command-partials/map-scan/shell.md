...
- Legacy atlas artifacts such as `PROJECT-HANDBOOK.md` and `.specify/project-map/**` may be read only when explicitly relevant to migration or export parity; they must not become scan targets.
