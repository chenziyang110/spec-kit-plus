...
- Use absolute paths for local file reads and artifact references. Exception: `specify-runtime artifact scaffold --path` must use a project-relative path; never pass an absolute `FEATURE_DIR` to scaffold commands.
