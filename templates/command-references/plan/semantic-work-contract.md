Trigger: when project-cognition-backed semantic intake, routing, permission, audit, resume, or final-claim rules affect the planning workflow.

Purpose: Preserve the shared semantic mediation and semantic-audit contract outside the planning main-flow prompt.
