Trigger: when project-cognition-backed semantic intake, routing, permission, audit, resume, or final-claim rules affect the analyze workflow.

Purpose: Preserve the shared semantic mediation and semantic-audit contract outside the analyze main-flow prompt.
