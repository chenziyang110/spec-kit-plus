...
- [fix-gate.md](fix-gate.md): Trigger: before applying a fix, changing source, or declaring the defect resolved.
- [regression-validation-and-closeout.md](regression-validation-and-closeout.md): Trigger: before session closeout, related-risk review, or blocked/resolved status.
- [debug-state.md](debug-state.md): Trigger: when creating, updating, resuming, or archiving the debug session file.
