Trigger: when project-cognition-backed semantic intake, routing, permission, audit, resume, or final-claim rules affect the clarify workflow.

Purpose: Preserve the shared semantic mediation and semantic-audit contract outside the clarify main-flow prompt.
