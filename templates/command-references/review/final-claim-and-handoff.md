...
- the validation-epoch ledger shared across Implement and Review was not reset,
  contains at most three source-fingerprint-bound epochs, and its latest required
  epoch passed; the third failed epoch blocks and Review never starts a fourth;
