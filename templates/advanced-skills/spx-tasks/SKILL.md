...
multi-batch, or obligation-rich work, also render the canonical
`task-index.json` from `.specify/templates/task-index-template.json`; a short
leader-direct sequence may stay in `tasks.md`. Every task needs a stable ID,
