---
description: Use when a project needs `specify-runtime design` to produce a DESIGN.md design-system contract, three inspectable HTML directions, refinement, or a readiness audit before UI work proceeds.
workflow_contract:
  ...
  primary_objective: Resolve design-shaping questions, obtain approval of one of three HTML-rendered directions, and let `specify-runtime design approve|export|lint` produce, refine, or audit the root `DESIGN.md` contract without implementing application UI.
