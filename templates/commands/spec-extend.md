...
Goal: Strengthen an existing spec package after `/sp.specify` by finding weak analysis, correcting misunderstandings, absorbing reference material better, and writing the improved results back into `spec.md`, `alignment.md`, and `references.md`.
