...
5. **Report**
   ...
   - [AGENT] Before the final report, capture any new `pitfall`, `workflow_gap`, or `project_constraint` learning through `{{specify-subcmd:learning capture --command fast ...}}`.
