...
3. **Load design documents**: Read from FEATURE_DIR:
   ...
   - **Required when present**: handoff-to-plan.json (authoritative route, intent, complexity, must-preserve invariants, allowed optimization scope, and planning obligations)
