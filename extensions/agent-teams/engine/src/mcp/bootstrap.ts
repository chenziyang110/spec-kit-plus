...
const SERVER_DISABLE_ENV: Record<McpServerName, string> = {
  state: 'SPECIFY_STATE_SERVER_DISABLE_AUTO_START',
  memory: 'SPECIFY_MEMORY_SERVER_DISABLE_AUTO_START',
  code_intel: 'SPECIFY_CODE_INTEL_SERVER_DISABLE_AUTO_START',
  trace: 'SPECIFY_TRACE_SERVER_DISABLE_AUTO_START',
  wiki: 'SPECIFY_WIKI_SERVER_DISABLE_AUTO_START',
};

const GLOBAL_DISABLE_ENV = 'SPECIFY_MCP_SERVER_DISABLE_AUTO_START';
const LIFECYCLE_DEBUG_ENV = 'SPECIFY_MCP_TRANSPORT_DEBUG';
const PARENT_WATCHDOG_INTERVAL_ENV = 'SPECIFY_MCP_PARENT_WATCHDOG_INTERVAL_MS';
const DUPLICATE_SIBLING_WATCHDOG_INTERVAL_ENV = 'SPECIFY_MCP_DUPLICATE_SIBLING_WATCHDOG_INTERVAL_MS';
const DUPLICATE_SIBLING_PRE_TRAFFIC_GRACE_ENV = 'SPECIFY_MCP_DUPLICATE_SIBLING_PRE_TRAFFIC_GRACE_MS';
const DUPLICATE_SIBLING_POST_TRAFFIC_IDLE_ENV = 'SPECIFY_MCP_DUPLICATE_SIBLING_POST_TRAFFIC_IDLE_MS';
